  ...
  const cards = [
    {
      ...
      change: 'Recorded from current session',
      changeType: 'neutral',
      icon: Activity,
    ...
    },
    {
      ...
      value: metrics.totalRequests > 0 ? metrics.hallucinationRatePercent + '%' : 'Not evaluated',
      subtext: 'Requires a downstream model response',
      icon: AlertTriangle,
    ...
    },
    {
      ...
      value: metrics.costSavedUSD > 0 ? '$' + metrics.costSavedUSD.toFixed(4) : 'Not measured',
      subtext: 'No pricing or cache provider configured',
      icon: Coins,
    ...
    },
    {
      ...
      subtext: 'Measured local processing time',
      icon: Clock,
      color: 'text-blue-400',
