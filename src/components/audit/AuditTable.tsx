...
export const AuditTable: React.FC = () => {
  ...
  const exportCSV = () => {
    const headers = ['RequestID', 'Timestamp', 'Application', 'Model', 'Decision', 'RiskScore', 'InputSHA256', 'LatencyMs'];
              ...
              {filteredEvents.length === 0 ? (
                <tr>
                  <td colSpan={8} className="p-8 text-center text-zinc-500 font-sans">
                    No runtime events recorded in this session.
                  </td>
                </tr>
                ...
                >
                  ...
                  <td className="p-3 text-right">
                    <button
                      onClick={() => setSelectedEvent(evt)}
                      className="flex items-center gap-1 text-indigo-400 hover:text-indigo-300 text-xs font-semibold ml-auto font-sans"
                    >
                      <span>Audit</span>
