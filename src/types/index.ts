...
export interface OutputSafetyEvaluation {
  evaluated: boolean;
  piiDetected: boolean;
  injectionDetected: boolean;
  toxicityScore: number;
  sanitizedOutput: string;
  engineStatus: 'NOT_EVALUATED' | 'PASSED' | 'WARNING' | 'BLOCKED' | 'INTERVENED';
  reason: string;
}
...
export interface RuntimeEvent {
  ...
  outputSafety?: OutputSafetyEvaluation;
  cost: CostEvaluation;
